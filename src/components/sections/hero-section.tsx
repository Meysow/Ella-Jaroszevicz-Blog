  ...
  return (
    ...
    >
      <div className="container flex flex-col items-center gap-6 text-center ">
        <h1
          className="font-urbanist text-4xl font-extrabold tracking-tight leading-tight sm:text-5xl md:text-6xl lg:text-7xl"
        ...
        <div className="max-w-5xl overflow-hidden flex justify-center mt-4 md:-mb-12 rounded-2xl shadow-lg shadow-muted-foreground">
          <Image alt="Paris landmark" src={PortraitPeint} priority={true} />
        </div>
      </div>
    </section>
  );
